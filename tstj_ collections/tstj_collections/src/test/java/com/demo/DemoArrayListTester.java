...
//    @Test
//    public void createArrayListStringTest() {
//    	System.out.println("createArrayListStringTest");
//    	DemoArrayList dal =  new DemoArrayList();
//    	assertEquals(new ArrayList<String>(), dal.createArrayListString());
//    }
...
//    	DemoArrayList dal =  new DemoArrayList();
//    	assertEquals(new ArrayList<Integer>(), dal.createArrayListString());
//    }
...
//    	List<Integer> testResultModel = Arrays.asList(testInputArr);
//    	assertEquals(testResultModel, subjectClass.createListFromArrayUsingArraysAsList(testInputArr));
//    }
...
//    	DemoArrayList subjectClass =  new DemoArrayList();
//    	ArrayList<String> testEmptyList = subjectClass.createArrayListString();
