...
public class DemoArrayList {
	...
	public ArrayList<String> getEmptyArrayListString() {
	...
	public ArrayList<Integer> createArrayListFromArrayUsingArraysAsList(Integer[] array) {
		//https://www.tutorialspoint.com/Conversion-of-Array-To-ArrayList-in-Java
		return(new ArrayList<Integer>(Arrays.asList(array)));
	}
	
	public ArrayList<String> createAndInitializeArrayListString() {
		  ArrayList<String> al=getEmptyArrayListString();
	      al.add("Steve");
	      al.add("Tim");
	      al.add("Lucy");
	      al.add("Pat");
	...
	public ArrayList<Integer> reverseArrayList(ArrayList<Integer> targetList){
